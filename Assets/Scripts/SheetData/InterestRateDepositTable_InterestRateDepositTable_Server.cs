...
{
	[Serializable]
	public class InterestRateDepositTable_Server : EERowData
	{
		[EEKeyField]
		[SerializeField]
		private long _UID;
		...
		public InterestRateDepositTable_Server()
		{
		}

#if UNITY_EDITOR
		public InterestRateDepositTable_Server(List<List<string>> sheet, int row, int column)
		{
	...
	public class InterestRateDepositTable_InterestRateDepositTable_Server : EERowDataCollection
	{
		
		public List<InterestRateDepositTable_Server> elements = new List<InterestRateDepositTable_Server>();

		public override void AddData(EERowData data)
		{
			elements.Add(data as InterestRateDepositTable_Server);
		}
