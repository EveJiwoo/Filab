...
{
	[Serializable]
	public class InterestRateLoanTable_Client : EERowData
	{
		[EEKeyField]
		[SerializeField]
		private long _UID;
		...
		public InterestRateLoanTable_Client()
		{
		}

#if UNITY_EDITOR
		public InterestRateLoanTable_Client(List<List<string>> sheet, int row, int column)
		{
	...
	public class InterestRateLoanTable_InterestRateLoanTable_Client : EERowDataCollection
	{
		
		public List<InterestRateLoanTable_Client> elements = new List<InterestRateLoanTable_Client>();

		public override void AddData(EERowData data)
		{
			elements.Add(data as InterestRateLoanTable_Client);
		}
...
public List<InterestRateLoanTable_Client> OnGetAllData()
		{		
return elements;
