...
{
	[Serializable]
	public class OccupationDataTable_Server : EERowData
	{
		[EEKeyField]
		[SerializeField]
		private long _UID;
		...
		public OccupationDataTable_Server()
		{
		}

#if UNITY_EDITOR
		public OccupationDataTable_Server(List<List<string>> sheet, int row, int column)
		{
	...
	public class OccupationDataTable_OccupationDataTable_Server : EERowDataCollection
	{
		
		public List<OccupationDataTable_Server> elements = new List<OccupationDataTable_Server>();

		public override void AddData(EERowData data)
		{
			elements.Add(data as OccupationDataTable_Server);
		}
